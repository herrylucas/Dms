...
<tr>
	...
	<th db="tryear" class="centered">Year</th>
...
while($row = pg_fetch_assoc($res)) {
	...
	echo "
		<tr class='tbl'>
				...
				<td class='centered'>" . uinput("tryear", $row["trid"], $row["tryear"], "trailers", "tryear", "trid", $row["trid"], true,false,50,"centered", null,null,false,true,false) . "</td>
