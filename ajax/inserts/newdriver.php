...
$res = pg_query($con, "insert into drivers (dname, dlicenceno, dlicenseexp, dpassportno, dpassportexp, company_id, demploymentdate, dcontractexpiry)
values (
...
" . $_SESSION["company"] . ",
'" . $_REQUEST['demploymentdate'] . "',
'" . $_REQUEST['dcontractexpiry'] . "'
) returning did
" );
