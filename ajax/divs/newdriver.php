...
$(document).ready(function () {
	$(function() {
		$( "#dlicenseexp, #dpassportexp, #dcontractexpiry, #demploymentdate" ).datepicker();
	});
		...
		if ($("#newfrm").valid() == true) {
			$.ajax({
				...
				data: {
					...
					dcontractexpiry: $("#dcontractexpiry").val(),
					demploymentdate: $("#demploymentdate").val(),
...
<div>
<label class="newitemlabel">Employment Date:</label> <input type="text" name="demploymentdate" id="demploymentdate"><br><br>
</div>
<div>
<label class="newitemlabel">Contract Expiry:</label> <input type="text" name="dcontractexpiry" id="dcontractexpiry"><br><br>
</div>
